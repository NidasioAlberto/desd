            ...
            case tx_state is
                ...
                when SEND_HEADER =>
                    if m_axis_tready = '1' then
                        ...
                        m_axis_tdata <= std_logic_vector(to_unsigned(0, 7 - JSTK_BITS)) & jstk_x(9 downto 9 - JSTK_BITS);
                    end if;
                when SEND_JSTK_X =>
                    if m_axis_tready = '1' then
                        tx_state     <= SEND_JSTK_Y;
                        m_axis_tdata <= std_logic_vector(to_unsigned(0, 7 - JSTK_BITS)) & jstk_y(9 downto 9 - JSTK_BITS);
                    end if;
                when SEND_JSTK_Y =>
                    if m_axis_tready = '1' then
