...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports external_clk]
...
# Leds
set_property PACKAGE_PIN U16 [get_ports {pwm_out[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[0]}]
set_property PACKAGE_PIN E19 [get_ports {pwm_out[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[1]}]
set_property PACKAGE_PIN U19 [get_ports {pwm_out[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[2]}]
set_property PACKAGE_PIN V19 [get_ports {pwm_out[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[3]}]
set_property PACKAGE_PIN W18 [get_ports {pwm_out[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[4]}]
set_property PACKAGE_PIN U15 [get_ports {pwm_out[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[5]}]
set_property PACKAGE_PIN U14 [get_ports {pwm_out[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[6]}]
set_property PACKAGE_PIN V14 [get_ports {pwm_out[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[7]}]
set_property PACKAGE_PIN V13 [get_ports {pwm_out[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[8]}]
set_property PACKAGE_PIN V3 [get_ports {pwm_out[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[9]}]
set_property PACKAGE_PIN W3 [get_ports {pwm_out[10]}]
