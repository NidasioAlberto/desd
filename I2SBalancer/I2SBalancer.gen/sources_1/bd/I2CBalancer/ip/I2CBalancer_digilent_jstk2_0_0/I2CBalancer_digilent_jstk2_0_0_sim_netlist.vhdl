...
--               Milano/Documenti/desd/I2SBalancer/I2SBalancer.gen/sources_1/bd/I2CBalancer/ip/I2CBalancer_digilent_jstk2_0_0/I2CBalancer_digilent_jstk2_0_0_sim_netlist.vhdl}
-- Design      : I2CBalancer_digilent_jstk2_0_0
...
entity I2CBalancer_digilent_jstk2_0_0_digilent_jstk2 is
  port (
  ...
  attribute ORIG_REF_NAME of I2CBalancer_digilent_jstk2_0_0_digilent_jstk2 : entity is "digilent_jstk2";
end I2CBalancer_digilent_jstk2_0_0_digilent_jstk2;

architecture STRUCTURE of I2CBalancer_digilent_jstk2_0_0_digilent_jstk2 is
  ...
  signal delay_counter : STD_LOGIC_VECTOR ( 27 downto 0 );
  ...
  signal \delay_counter0_carry__5_n_2\ : STD_LOGIC;
  ...
  signal \delay_counter[27]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \NLW_delay_counter0_carry__5_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_delay_counter0_carry__5_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \delay_counter[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \delay_counter[10]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \delay_counter[11]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \delay_counter[12]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \delay_counter[13]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \delay_counter[14]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \delay_counter[15]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \delay_counter[16]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \delay_counter[17]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \delay_counter[18]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \delay_counter[19]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \delay_counter[21]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \delay_counter[22]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \delay_counter[23]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \delay_counter[24]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \delay_counter[25]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \delay_counter[26]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \jstk_x[9]_i_2\ : label is "soft_lutpair4";
...
\delay_counter0_carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_delay_counter0_carry__5_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \delay_counter0_carry__5_n_2\,
      CO(0) => \delay_counter0_carry__5_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_delay_counter0_carry__5_O_UNCONNECTED\(3),
      O(2 downto 0) => data0(27 downto 25),
      S(3) => '0',
      S(2 downto 0) => delay_counter(27 downto 25)
    );
...
\delay_counter[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\delay_counter[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\delay_counter[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\delay_counter[0]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
\delay_counter[0]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\delay_counter[0]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
\delay_counter[24]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\delay_counter[25]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\delay_counter[26]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\delay_counter[27]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\delay_counter_reg[27]\: unisim.vcomponents.FDCE
     port map (
      C => aclk,
      CE => delay_counter_0,
      CLR => \FSM_sequential_state_cmd[2]_i_2_n_0\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity I2CBalancer_digilent_jstk2_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    m_axis_tvalid : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of I2CBalancer_digilent_jstk2_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of I2CBalancer_digilent_jstk2_0_0 : entity is "I2CBalancer_digilent_jstk2_0_0,digilent_jstk2,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of I2CBalancer_digilent_jstk2_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of I2CBalancer_digilent_jstk2_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of I2CBalancer_digilent_jstk2_0_0 : entity is "digilent_jstk2,Vivado 2020.2";
end I2CBalancer_digilent_jstk2_0_0;

architecture STRUCTURE of I2CBalancer_digilent_jstk2_0_0 is
...
begin
U0: entity work.I2CBalancer_digilent_jstk2_0_0_digilent_jstk2
     port map (
      aclk => aclk,
      aresetn => aresetn,
      btn_jstk => btn_jstk,
