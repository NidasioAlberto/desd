...
--               Milano/Documenti/desd/I2SBalancer/I2SBalancer.gen/sources_1/bd/I2CBalancer/ip/I2CBalancer_axi4stream_spi_master_0_0/I2CBalancer_axi4stream_spi_master_0_0_sim_netlist.vhdl}
-- Design      : I2CBalancer_axi4stream_spi_master_0_0
...
entity I2CBalancer_axi4stream_spi_master_0_0_lw_spi_master is
  port (
    cs_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of I2CBalancer_axi4stream_spi_master_0_0_lw_spi_master : entity is "lw_spi_master";
end I2CBalancer_axi4stream_spi_master_0_0_lw_spi_master;

architecture STRUCTURE of I2CBalancer_axi4stream_spi_master_0_0_lw_spi_master is
  ...
  signal edgecntr : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal \edgecntr[0]_i_1_n_0\ : STD_LOGIC;
  signal \edgecntr[10]_i_1_n_0\ : STD_LOGIC;
  signal \edgecntr[10]_i_3_n_0\ : STD_LOGIC;
  signal \edgecntr[10]_i_4_n_0\ : STD_LOGIC;
  signal \edgecntr[10]_i_5_n_0\ : STD_LOGIC;
  signal \edgecntr[10]_i_6_n_0\ : STD_LOGIC;
  signal \edgecntr[5]_i_2_n_0\ : STD_LOGIC;
  signal \edgecntr[9]_i_2_n_0\ : STD_LOGIC;
  signal edgecntr_0 : STD_LOGIC_VECTOR ( 10 downto 1 );
  ...
  attribute SOFT_HLUTNM of cs_o_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of data_ready_reg_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \edgecntr[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \edgecntr[10]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \edgecntr[10]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \edgecntr[1]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \edgecntr[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \edgecntr[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \edgecntr[5]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \edgecntr[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \edgecntr[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \edgecntr[8]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of mosi_o_i_3 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of new_data_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of sclk_en_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of sclk_prev_i_1 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of state_i_2 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \write_reg[7]_i_4\ : label is "soft_lutpair13";
...
\edgecntr[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \edgecntr[10]_i_4_n_0\,
      I1 => edgecntr(0),
      O => \edgecntr[0]_i_1_n_0\
    );
\edgecntr[10]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => sclk_en,
      O => \edgecntr[10]_i_1_n_0\
    );
\edgecntr[10]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6A00"
    )
        port map (
      I0 => edgecntr(10),
      I1 => edgecntr(9),
      I2 => \edgecntr[10]_i_3_n_0\,
      I3 => \edgecntr[10]_i_4_n_0\,
      O => edgecntr_0(10)
    );
\edgecntr[10]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      I0 => edgecntr(8),
      I1 => edgecntr(6),
      I2 => \edgecntr[9]_i_2_n_0\,
      I3 => edgecntr(7),
      O => \edgecntr[10]_i_3_n_0\
    );
\edgecntr[10]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFF7F"
    )
        port map (
      ...
      I1 => edgecntr(8),
      I2 => edgecntr(2),
      I3 => \edgecntr[10]_i_5_n_0\,
      I4 => \edgecntr[10]_i_6_n_0\,
      O => \edgecntr[10]_i_4_n_0\
    );
\edgecntr[10]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => edgecntr(7),
      I3 => edgecntr(1),
      O => \edgecntr[10]_i_5_n_0\
    );
\edgecntr[10]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
      ...
      I2 => edgecntr(4),
      I3 => edgecntr(9),
      O => \edgecntr[10]_i_6_n_0\
    );
\edgecntr[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"60"
    )
        port map (
      I0 => edgecntr(1),
      I1 => edgecntr(0),
      I2 => \edgecntr[10]_i_4_n_0\,
      O => edgecntr_0(1)
    );
\edgecntr[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6A00"
    )
        port map (
...
\edgecntr[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => edgecntr(0),
      I4 => edgecntr(2),
      I5 => \edgecntr[10]_i_4_n_0\,
      O => edgecntr_0(4)
    );
\edgecntr[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"60"
    )
        port map (
      I0 => edgecntr(5),
      I1 => \edgecntr[5]_i_2_n_0\,
      I2 => \edgecntr[10]_i_4_n_0\,
      O => edgecntr_0(5)
    );
\edgecntr[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
      ...
      I3 => edgecntr(1),
      I4 => edgecntr(3),
      O => \edgecntr[5]_i_2_n_0\
    );
\edgecntr[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"60"
    )
        port map (
      I0 => edgecntr(6),
      I1 => \edgecntr[9]_i_2_n_0\,
      I2 => \edgecntr[10]_i_4_n_0\,
      O => edgecntr_0(6)
    );
\edgecntr[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6A00"
    )
        port map (
...
\edgecntr[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => edgecntr(8),
      I2 => edgecntr(6),
      I3 => \edgecntr[9]_i_2_n_0\,
      I4 => edgecntr(7),
      I5 => \edgecntr[10]_i_4_n_0\,
      O => edgecntr_0(9)
    );
\edgecntr[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity I2CBalancer_axi4stream_spi_master_0_0_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of I2CBalancer_axi4stream_spi_master_0_0_axis_lw_spi_master : entity is "axis_lw_spi_master";
end I2CBalancer_axi4stream_spi_master_0_0_axis_lw_spi_master;

architecture STRUCTURE of I2CBalancer_axi4stream_spi_master_0_0_axis_lw_spi_master is
...
inst_lw_spi_master: entity work.I2CBalancer_axi4stream_spi_master_0_0_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity I2CBalancer_axi4stream_spi_master_0_0_ipi_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of I2CBalancer_axi4stream_spi_master_0_0_ipi_axis_lw_spi_master : entity is "ipi_axis_lw_spi_master";
end I2CBalancer_axi4stream_spi_master_0_0_ipi_axis_lw_spi_master;

architecture STRUCTURE of I2CBalancer_axi4stream_spi_master_0_0_ipi_axis_lw_spi_master is
begin
inst_axis_lw_spi_master: entity work.I2CBalancer_axi4stream_spi_master_0_0_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity I2CBalancer_axi4stream_spi_master_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of I2CBalancer_axi4stream_spi_master_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of I2CBalancer_axi4stream_spi_master_0_0 : entity is "I2CBalancer_axi4stream_spi_master_0_0,ipi_axis_lw_spi_master,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of I2CBalancer_axi4stream_spi_master_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of I2CBalancer_axi4stream_spi_master_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of I2CBalancer_axi4stream_spi_master_0_0 : entity is "ipi_axis_lw_spi_master,Vivado 2020.2";
end I2CBalancer_axi4stream_spi_master_0_0;

architecture STRUCTURE of I2CBalancer_axi4stream_spi_master_0_0 is
...
U0: entity work.I2CBalancer_axi4stream_spi_master_0_0_ipi_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
